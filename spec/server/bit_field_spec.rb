...
describe BitFields::BitField do
  ...
  it 'should initialize from array' do
    ...
    bf.bit_field.f1.must_equal [1]
    bf.bit_field.f2.must_equal [1,1,0]
    bf.bit_field.f3.must_equal [0,1,0,1]
  end
  ...
  it 'should handle edge cases' do
    ...
    bf.bit_field.f1.must_equal [1,1,1]
    bf.bit_field.f3.must_equal [1]
  end
